...
/*  struct stu
    ...
    char num_9 = 5;
    char num_10 = 126;
    char num_11 = num_10 + num_9;
    printf("%d\n", num_11);//-125
    //num_9 =  00000101   5
    //num_10 = 01111110   126
    //num_9 =  00000000000000000000000000000101
    //num_10 = 00000000000000000000000001111110
    //num_11 = 10000011
    //num_11 = 11111111111111111111111110000011  补码 整形提升
    //num_11 = 11111111111111111111111110000010
    //num_11 = 10000000000000000000000001111101 符号位(1) 125

    int num_12 = 1;
    int num_13 = (++num_12) + (++num_12) + (++num_12);//问题代码
    printf("num_13 = %d\n", num_13);
